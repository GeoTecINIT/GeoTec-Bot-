<?php
  ...
  **/
  ...
  function log_conversation($convoArr)
  {
    ...
    //clean and set
	$usersay_org = $convoArr['aiml']['usersay_org'];
  ...
  function check_set_user($convoArr)
  {
    ...
    $sql = "select `user_name`, `id`, `chatlines`, `bot_id` from `$dbn`.`users` where `session_id` = :convo_id limit 1;";
	...
	$convoArr['conversation']['user_bot_id'] = $bot_id;
    $convoArr['conversation']['user_name'] = $user_name;
